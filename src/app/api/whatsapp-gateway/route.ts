...
export async function POST(req: NextRequest) {
  try {
    ...
    if (messageType === 'voice_note' || text?.toLowerCase().includes('torque') || text?.toLowerCase().includes('physics')) {
      ...
      responseText = '*[NEXUS Micro-LMS]* ??\n\n' +
        'Welcome to Omni-Sync WhatsApp Learning! Send any:\n' +
        '1?? Voice note in Hindi/Tamil/English asking a science question\n' +
        '2?? Photo of handwritten math/code\n' +
